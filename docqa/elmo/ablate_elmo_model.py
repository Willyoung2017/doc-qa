        ...
        match_encoder=SequenceMapperSeq(FullyConnected(dim * 2, activation="relu"),
                                        ResidualLayer(SequenceMapperSeq(
                                           ...
                                           # StaticAttentionSelf(TriLinear(bias=True), ConcatWithProduct()),
                                            MultiSelfAttention(3, None, merge=ConcatWithProduct()),#, None, None, False, False, False, "glorot_uniform", 
                                                              # ConcatWithProduct(), True, True),
                                            MultiSelfAttention(3, None, merge=ConcatWithProduct()),
                                            MultiSelfAttention(3, None, merge=ConcatWithProduct()),
