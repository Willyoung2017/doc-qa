...
from docqa.nn.attention import BiAttention, StaticAttentionSelf, MultiSelfAttention
from docqa.nn.embedder import FixedWordEmbedder, CharWordEmbedder, LearnedCharEmbedder, SRLTagEmbedder
...
def main():
    parser = argparse.ArgumentParser("Tarain our ELMo model on SQuAD")
    ...
    parser.add_argument("--tag_dim", type=int, default=5)
    ...
    model = AttentionWithElmo(
        ...
        max_batch_size=128,
        tag_embed=SRLTagEmbedder(tag_dim=args.tag_dim),
        ...
        match_encoder=SequenceMapperSeq(FullyConnected(dim * 2, activation="relu"),
                                        ResidualLayer(SequenceMapperSeq(
                                            ...
                                            #MultiSelfAttention(5, None, None, False, False, False, "glorot_uniform",
                                            #                   ConcatWithProduct(), True, True),
